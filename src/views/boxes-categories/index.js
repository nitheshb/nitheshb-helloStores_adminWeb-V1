...
const RecipeCategories = () => {
  ...
  function goToEdit(row) {
    dispatch(
      addMenu({
        url: `box-category/edit/${row.uuid}`,
        id: 'category_edit',
        name: t('edit.category'),
      }),
    );
    navigate(`/box-category/edit/${row.uuid}`, { state: 'edit' });
  }
  ...
  const goToAddCategory = () => {
    dispatch(
      addMenu({
        id: 'category-add',
        url: 'box-category/add',
        name: t('add.category'),
      }),
    );
    navigate('/box-category/add');
  };

  const goToImport = () => {
    dispatch(
      addMenu({
        url: `box-categories/import`,
        id: 'category_import',
        name: t('import.category'),
      }),
    );
    navigate(`/box-categories/import`);
  };
  ...
  const goToClone = (uuid) => {
    dispatch(
      addMenu({
        id: `category-clone`,
        url: `box-category-clone/${uuid}`,
        name: t('category.clone'),
      }),
    );
    navigate(`/box-category-clone/${uuid}`, { state: 'clone' });
  };
