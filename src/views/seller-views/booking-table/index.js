...
const BookingTables = () => {
  ...
  const goToEdit = (id) => {
    dispatch(
      addMenu({
        ...
        url: `seller/booking/table/${id}`,
        name: t('booking.table.edit'),
      }),
    );
    navigate(`/seller/booking/table/${id}`);
  };
  ...
  const goToClone = (id) => {
    dispatch(
      addMenu({
        ...
        url: `seller/booking/table/clone/${id}`,
        name: t('booking.table.clone'),
      }),
    );
    navigate(`/seller/booking/table/clone/${id}`);
  };
  ...
  const fetchSellerBookingTableLocal = () => {
    dispatch(fetchBookingTable(paramsData));
    dispatch(disableRefetch(activeMenu));
  };

  useEffect(() => {
    fetchSellerBookingTableLocal();
